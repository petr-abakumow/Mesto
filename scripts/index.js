...
popupCloseButton.addEventListener('click', () => popupClosed(popup));
...
function popupImageOpen(data) {
    ...
    popupOpened(popupImageContainer);
};
...
popupImageClose.addEventListener('click', () => popupClosed(popupImageContainer));
...
popupAddElementClose.addEventListener('click', () => popupClosed(popupAddElement));
